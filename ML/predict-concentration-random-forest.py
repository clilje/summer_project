...
X_ratio = pd.DataFrame([sorted_data['SubhaloGasMass'],sorted_data['SubhaloStarMass'],
                         ...
                         sorted_data_dark['SubhaloDMMass']]).T
...
#Plot predicted vs actual
axs[2].hexbin(ytest_ratio,y_pred_ratio, gridsize = 1000, cmap ='Greens',xscale ='log',yscale='log')
...
fig.savefig('concentration_ratio_masses_hex.jpg')

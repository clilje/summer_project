...
print(y)
print(y_pred)
axs[0,0].scatter(y,y_pred, marker="x",color="black")

axs[0,0].set_xlabel(r'Concentration of Halos')
axs[0,0].set_ylabel(r'Predicted Concentration of Halos')
axs[0,0].set_xscale('log')
axs[0,0].set_yscale('log')
axs[0,0].set_title('Prediced Halo Concentration from Stellar, Gas, BH and DM Mass')
...
print(y_dark)
print(y_pred_dark)
axs[0,1].scatter(y_dark,y_pred_dark, marker="x",color="black")
axs[0,1].set_xlabel(r'Concentration of DMO Halos')
axs[0,1].set_ylabel(r'Predicted Concentration of DMO Halos')
axs[0,1].set_xscale('log')
axs[0,1].set_yscale('log')
axs[0,1].set_title('Prediced Halo Concentration from DM Mass')

conc_ratio = y/y_dark
conc_ratio_pred = y_pred/y_pred_dark
plt.scatter(conc_ratio,conc_ratio_pred, marker="x",color="black")
axs[0,2].set_xlabel(r'Ratio of $\frac{C_{B}}{C_{DMO}}$')
axs[0,2].set_ylabel(r'Predicted Ratio of $\frac{C_{B}}{C_{DMO}}')
axs[0,2].set_xscale('log')
axs[0,2].set_yscale('log')
axs[0,1].set_title('Predicted Halo Concentration ratio from Stellar, Gas, BH and DM Mass')

...
lhalotree_dir = f'/disk01/rmcg/downloaded/tng/tng{box_size}-{run}-dark/merger_tree/lhalotree/'
...
data = all_trees.set_index('index')
print(data)
data.to_csv('50-1-subhalo-history-dark.csv')

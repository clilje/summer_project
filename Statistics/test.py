...
index = np.random.choice(xyz,2)
ax.scatter(partx[index], party[index], partz[index], marker='+',color='blue',alpha=1)
ax.scatter(halo_50[0], halo_50[1], halo_50[2], marker='+',color='red')
ax.scatter(subhalos['SubhaloCM'][index_sub, 0],subhalos['SubhaloCM'][index_sub, 1], subhalos['SubhaloCM'][index_sub, 2], color='black')

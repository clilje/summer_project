...
for g in gg:
    ...
    #xy = range(20)
    z = chisquare
    sc = axs[0].errorbar(binsizes, scale_den, c=z,yerr=uncer_den, markersize=300,marker='*')
    ...
    sc2 = axs[1].errorbar(binsizes, scale_rad, c=z,yerr=uncer_rad, markersize=300,marker='*')

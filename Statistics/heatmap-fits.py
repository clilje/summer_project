...
for g in gg:
    ...
    nfwfitp, nfwfitcov = scopt.curve_fit(nfw, rad, den, p0=[rad[-1],den[-1]], sigma=uncer)
    ...
    einastofitp, einastofitcov = scopt.curve_fit(einasto, rad, den, p0=[rad[-1],den[-1],5], sigma=uncer)
    ...
    burkertfitp, burkertfitcov = scopt.curve_fit(burkert,rad, den, p0=[rad[-1],den[-1]], sigma=uncer)
    ...
    dehnen_twoparamfitp, dehnen_twoparamfitcov = scopt.curve_fit(dehnen_twoparam, rad, den, p0=[rad[-1],den[-1]], sigma=uncer)
    ...
    dehnen_threeparamfitp, dehnen_threeparamfitcov = scopt.curve_fit(dehnen_threeparam, rad, den, p0=[rad[-1],den[-1],0.02], sigma=uncer)

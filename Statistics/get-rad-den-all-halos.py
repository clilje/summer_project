...
while g < 4003:
    data_csv = pd.read_csv('HaloParticles50-1-pd/snap_99_halo_'+str(g)+'.csv', dtype={'':'int','ID':'int','Type':'str','x':'float','y':'float','z':'float','mass':'float','vx':'float','vy':'float','vz':'float'})
    print(data_csv)

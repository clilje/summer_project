...
positionsX = pd.read_csv('HaloFits/50-4_halodata.csv')['HaloPosX'].to_numpy()
positionsY = pd.read_csv('HaloFits/50-4_halodata.csv')['HaloPosY'].to_numpy()
positionsZ = pd.read_csv('HaloFits/50-4_halodata.csv')['HaloPosZ'].to_numpy()
radius = pd.read_csv('HaloFits/50-4_halodata.csv')['HaloHMrad'].to_numpy()
...
radii = []
while g < numhalos:
    data_csv = pd.read_csv('HaloParticles/50-4_snap_halo_'+str(g)+'_pos_mass.csv')
    rad_den = radial_density(data_csv['x'].to_numpy(), data_csv['y'].to_numpy(), data_csv['z'].to_numpy(),data_csv['mass'].to_numpy(), 40, radius[g], positionsX[g], positionsY[g], positionsZ[g])
    #print(rad_den)
    hmrad = radius[g]

...
while i<len(rho_s):
    ...
    #print(nfwfitp)
        nfwfitplist = np.append(nfwfitplist, nfwfitp)
        nfwfitcovlist = np.append(nfwfitcovlist, nfwfitcov)
        g+=1
    i+=1
...
dehnen_twoparamfitp, dehnen_twoparamfitcov = scopt.curve_fit(dehnen_twoparam, radii[0], densities[0], p0=[0.001,1], sigma=uncertainties[0])
...
dehnen_threeparamfitp, dehnen_threeparamfitcov = scopt.curve_fit(dehnen_threeparam, radii[0], densities[0], p0=[0.001,1,3], sigma=uncertainties[0])

...
axs[0,0].legend()
axs[0,0].text(0.01,1,'$\eta$='+str(enhance[0]),horizontalalignment='center', verticalalignment='center', transform=axs[0,0].transAxes)
...
axs[0,1].text(0.01,1,'$\eta$='+str(enhance[1]),horizontalalignment='center', verticalalignment='center', transform=axs[0,1].transAxes)
...
axs[1,0].legend()
axs[1,0].text(0.01,1,'$\eta$='+str(enhance[2]), horizontalalignment='center', verticalalignment='center', transform=axs[1,0].transAxes)
...
axs[1,1].legend()
axs[1,1].text(0.01,1,'$\eta$='+str(enhance[3]),horizontalalignment='center', verticalalignment='center', transform=axs[1,1].transAxes)

...
def treePath(basePath, chunkNum=0):
    ...
    #don't think this exists in Robs downloads
    filePath = basePath + '/merger_tree/lhalotree/' + 'trees_sf1_135.' + str(chunkNum) + '.hdf5'

    if not isfile(filePath):
        # new path scheme
        filePath = basePath + '/merger_tree/lhalotree/trees_sf1_099.' + str(chunkNum) + '.hdf5'
